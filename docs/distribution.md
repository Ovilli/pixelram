...
{: .important }
Use a release tag such as `v0.1.20`, not `main`, in teaching material. A pinned tutorial should keep compiling even after PixelRAM evolves.
